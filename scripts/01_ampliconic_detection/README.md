...
**Modifications:** The original script has been adapted to include an additional primate species (Macaca fascicularis) in the analysis.
...
- Palindrome annotation file from Makova et al., 2024 (available at [their GitHub/supplement link])
- Sequence classification file from Makova et al., 2024
...
These gene_details files are used as input for the clustering scripts below, together with the reference genomes.
...
## Workflow Summary
```
Reference genomes + Palindrome/sequence calss files
          ↓
