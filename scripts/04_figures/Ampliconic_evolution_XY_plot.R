...
ggsave("plot_withstrata_final3.0.jpg", p_final, width = plot_width, height = plot_height, dpi = 400)
...
ggsave("~/Downloads/X_chrom_clusters_filtered_withdNdS_updated_try22.pdf", p, width = 20, height = 25, units = "in")
